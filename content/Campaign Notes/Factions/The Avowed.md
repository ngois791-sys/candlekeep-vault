...
The Avowed are the scholarly monastic order that maintains Candlekeep and its vast library. They are humble scholars first and defenders second — but several of their most senior members are among the most powerful spellcasters on the Sword Coast. They have maintained Candlekeep for centuries and take their responsibility with deep, quiet seriousness.
...
## The Orders of Accordance

All who enter Candlekeep agree to these rules. Violation means permanent banishment.

- **No Fighting** — all disputes via cordial debate only
- **No Stealing** — applies to all objects, not just library works
- **No Copying** — full copies must be made at the House of the Binder and paid for
- **No Damaging Works** — does not apply to privately owned items

---

## Magical Wards

- **Magic Restriction** — no one may enter by any route except the front gates; magical bypass fails; magical flight is dispelled 50 ft outside the walls; tiny birds are unaffected
- **Fire Suppression** — flames larger than a candle are suppressed; fire spells fail inside the keep; exception: the fireplace in the Hearth
- **Theft Protection** — any Candlekeep collection item removed from the keep instantly returns to its proper place; torn pages can be removed if the bulk of the work remains
- **Shielding Mythal** — the Keeper of Tomes can activate a full-keep shield from anywhere inside Candlekeep; nothing but air and sound passes through

---

## Defenses

Candlekeep is fortified by 50-ft tall, 15-ft thick iron-reinforced stone walls with a double gate facing east. If trouble occurs, the Gatewarden and up to four mages arrive immediately. If they cannot contain the situation, up to four additional archmages join them.
...
Keeper of Tomes (1)
    └── First Reader (1)
        └── Great Readers (8)
            └── Gatewarden (1)
            └── Chanter (1)
            └── Avowed Adjutants, Scribes, Priests, Custodians
```
...
### Bookwyrm (Skoda Valanaster) — First Reader
...
_Human Master Sage | Worshiper of Oghma | Expertise: Divinity_
...
### Fheminor Scrivenbark — Great Reader
...
### Benedora Stoneforge — Chanter

_Middle-Aged Shield Dwarf Priest of Milil_
...
_Human Archmage | Maintains Security at the Front Gates_
...
### Kei Tigersteel — Lorekeeper / Temple Caretaker

_Human Priest of Shou Descent | Temple of Oghma_
...
_Ogre wearing a Headband of Intellect | Permanent Resident_
...
|d8|Adjutant|
|---|---|
|1|Fembris Larlancer — 18, human, bright smile, can-do attitude, obnoxious need to impress|
|2|Sprig Summerfoot — 23, halfling, ink-stained fingers, cookies in pocket, good memory for recipes|
|3|Parmak — 25, human, constantly reading, occasionally walks into things|
|4|Garlyth Graystock — 39, dwarf, cuts people off mid-sentence, always seems to know what they want|
|5|Nax Olossis — 22, dragonborn (brass ancestry), loves conversation|
|6|Orrin Glass — 67, human, deaf in one ear, forgetful, easily exasperated|
|7|Vooshadi Moonriver — 87, moon elf, stoic, difficult to anger, does not mince words|
|8|Irony — 15, tiefling, follows rules, never lies or steals, aspires to be Keeper of Tomes one day|
...
When the truth comes out, the Avowed will be horrified — and they will want to act. V'ziir-Ag, Teles Ahvoste, and A'lai Aivenmore are the Great Readers most likely to take a leading role in responding to the crisis once the party brings them evidence.
...
- [[Candlekeep Informants]] — Pell, Thessaly, and Caelix are all Avowed members working (unknowingly) against the conspiracy
- [[Keepers of Forbidden Lore]] — the organization that has been operating inside their walls
- [[Kei Tigersteel]] — their trusted Lorekeeper, compromised