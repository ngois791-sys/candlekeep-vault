...
![Mazfroth's Mighty Digressions](Mechanics/CLI/adventures/candlekeep-mysteries/img/015-03-001-mazfroths-mighty-digressions.webp#center)
...
When the [gingwatzim](Mechanics/CLI/bestiary/aberration/gingwatzim-cm.md) that has taken the form of *Mazfroth's Mighty Digressions* attacks the characters, it does so by assuming its true form and then using its Energy Drain action. A gingwatzim must feed on the life energy of other creatures to survive, but it can't feed while in the form of a beast or an object, which is why it must revert to its true form first. Its other form is that of a bat.
...
With Korvala as their new leader, the pack began working on a way to resurrect Nidalia. It soon became clear that wouldn't be a simple task. After all, the [resurrection](Mechanics/CLI/spells/resurrection-xphb.md) spell requires both a diamond worth at least 1,000 gp and the services of a sufficiently powerful spellcaster.
...
If the characters talk to the Avowed about the incident they experienced involving *Mazfroth's Mighty Digressions*, the monks offer them a [helm of comprehending languages](Mechanics/CLI/items/helm-of-comprehending-languages-xdmg.md) as a reward for finding out who is responsible for the deception.
...
![Amberdune Books](Mechanics/CLI/adventures/candlekeep-mysteries/img/016-03-002-amberdune-books.webp#center)
...
On the fourth night of their journey, the party is attacked by the [wererat](Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) Mushika and three [giant rats](Mechanics/CLI/bestiary/beast/giant-rat-xmm.md). Mushika bears nasty scars from his time in the thieves' guilds of Baldur's Gate, and has since turned to easier prey along the Coast Way. While the giant rats attack, Mushika stands back in hybrid form and uses his hand crossbow. He tries to flee if he's reduced to half his hit points or fewer or if all three giant rats are defeated.
...
- Coppers to Crowns, an "antiques" shop selling a miscellany of trinkets and oddities (roll `2d4` times on the [Trinkets table](Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook"). Each trinket costs `2d10` cp.  
...
- Wizards of the Wide, a tent bursting with dozens of arcane foci and [spell scrolls](Mechanics/CLI/items/spell-scroll-xdmg.md), including scrolls of [comprehend languages](Mechanics/CLI/spells/comprehend-languages-xphb.md), [detect magic](Mechanics/CLI/spells/detect-magic-xphb.md), [feather fall](Mechanics/CLI/spells/feather-fall-xphb.md), [find familiar](Mechanics/CLI/spells/find-familiar-xphb.md), [mage armor](Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](Mechanics/CLI/spells/magic-missile-xphb.md), [shield](Mechanics/CLI/spells/shield-xphb.md), and [unseen servant](Mechanics/CLI/spells/unseen-servant-xphb.md) (25 gp each).  
...
Amberdune Books is always supervised by two [jackalweres](Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in humanoid form. At sunrise, those on the first shift set up the stall with Korvala, and at sundown the workers bring their unsold wares back to the pack's hideout in the Blackgate neighborhood.
...
There are seven [jackalweres](Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in the Amberdune Pack, including the leader, Korvala. The other pack members are as follows:
...
![Korvala](Mechanics/CLI/adventures/candlekeep-mysteries/img/017-03-003-korvala.webp#center)
...
> [!gallery]
> ![Map 3.1: Amberdune Hideout](Mechanics/CLI/adventures/candlekeep-mysteries/img/018-map-3-01-amberdune-hideout.webp#gallery)
> ![Player Version](Mechanics/CLI/adventures/candlekeep-mysteries/img/019-map-3-01-amberdune-hideout-player.webp#gallery)
...
The jackalweres like to relax and chat with each other in this room, particularly during and after meals together. The faded rug is actually a [rug of smothering](Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md) friendly to the jackalweres, which defends them if they command it to. If no jackalweres are present in this area, the rug attacks intruders. It stops fighting if one of the jackalweres commands it to.

##### Development

Noise from fighting the rug of smothering causes Marliza, a [jackalwere](Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in hybrid form, to run into the room from area A2, scimitar at the ready. This jackalwere is willing to command the rug to stop if the characters explain themselves.
...
The decorative swords on the wall are actually two [gingwatzims](Mechanics/CLI/bestiary/aberration/gingwatzim-cm.md) (see the stat block) that assume their true forms and attack intruders unless Korvala is present. If she is attacked in this room, the gingwatzims defend her. In addition to appearing as swords, these gingwatzims can turn into bats.
...
- Using a ritual taught to her by Nidalia, Korvala can create creatures known as gingwatzims. (Korvala claims to be under the effect of a [geas](Mechanics/CLI/spells/geas-xphb.md) spell cast by Nidalia that prevents her from sharing this knowledge. This is a lie. Regardless, Korvala will not divulge the ritual.)  
...
If the party has difficulty finding the hidden vault in area A6, any of the characters can make a DC 10 Intelligence ([Investigation](Mechanics/CLI/rules/skills.md#Investigation)) check. On a success, they arrive at one of the realizations from the following list. If the check succeeds by 5 or more, they come up with all three:
...
If characters return to Candlekeep with the books, the Avowed reward them with a [helm of comprehending languages](Mechanics/CLI/items/helm-of-comprehending-languages-xdmg.md). Valor and Yalerion are grateful for the party's efforts to solve the mystery. Both seekers could be useful allies in the future.
