...
- **Craft.** Smith's Tools. The facility's hirelings craft anything that can be made with [Smith's Tools](Mechanics/CLI/items/smiths-tools-xphb.md), using the rules in the "Player's Handbook".  
