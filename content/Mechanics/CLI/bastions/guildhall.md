...
| Shipbuilders' Guild | Crossed oars | You assign shipbuilders to build one of the vehicles in the [Airborne and Waterborne Vehicles](Mechanics/CLI/tables/large-vehicles-airborne-and-waterborne-vehicles-xphb.md) table of the "Player's Handbook". You pay the full cost of the vehicle, and the work takes 1 day per 1,000 GP of the vehicle's cost (a [Rowboat](Mechanics/CLI/items/rowboat-xphb.md) can be made in 1 day). |
