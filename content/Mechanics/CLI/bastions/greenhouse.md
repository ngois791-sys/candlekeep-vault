...
- **Harvest.** Healing Herbs. You commission the facility's hireling to create a [Potion of Healing (greater)](Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) made from healing herbs. The work takes 7 days and costs no money.  
- **Harvest.** Poison. You commission the facility's hireling to extract one application of a poison from rare plants or fungi. Choose the type of poison from the following options: [Assassin's Blood](Mechanics/CLI/items/assassins-blood-xdmg.md), [Malice](Mechanics/CLI/items/malice-xdmg.md), [Pale Tincture](Mechanics/CLI/items/pale-tincture-xdmg.md), or [Truth Serum](Mechanics/CLI/items/truth-serum-xdmg.md). See ""Poison"" in "chapter 3" for each poison's effect. Once harvested, the poison can be contained in a vial. The work takes 7 days and costs no money.  
