...
Any creature that enters poisonous gas for the first time on a turn or starts its turn there makes a DC 12 Constitution saving throw, taking 5 (`1d10`) Poison damage on a failed save or half as much damage on a successful one. Creatures in the gas also have [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on [Death Saving Throws](Mechanics/CLI/rules/variant-rules/death-saving-throw-xphb.md).
