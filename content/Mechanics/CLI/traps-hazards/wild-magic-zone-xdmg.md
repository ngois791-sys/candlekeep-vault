...
Whenever a creature expends a spell slot to cast a spell in a wild magic zone, roll `1d20`. If you roll a 20 on the die, roll on the [Wild Magic Surge](Mechanics/CLI/tables/wild-magic-surge-xphb.md) table in the "Player's Handbook" to create a magical effect.
