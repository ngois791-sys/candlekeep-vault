...
- Pech Lithlord
---
# [Pech Lithlord](Mechanics\CLI\bestiary\elemental/pech-lithlord-ccodex.md)
...
"cr": "7"
"traits":
  - "desc": "The pech lithlord's innate spellcasting ability is Wisdom (spell save\
      \ DC 15). It can innately cast the following spells, requiring no material components:\n\
      \n**At will:** [mending](Mechanics/CLI/spells/mending-xphb.md), [thunderwave](Mechanics/CLI/spells/thunderwave-xphb.md)\
      \ (4d8)\n\n**3/day each:** [shatter](Mechanics/CLI/spells/shatter-xphb.md)\
  ...
  - "desc": "rAs a bonus action, the pech can draw on the power of unworked stone,\
...
"actions":
  - "desc": "The pech lithlord makes three attacks. two with its pick and one with\
      \ its hammer. If the pech lithlord hits the same target with two attacks, the\
      \ target must succeed on a DC 15 Constitution saving throw or be [stunned](Mechanics/CLI/rules/conditions.md#Stunned)\
...
"source":
  - "CCodex"
"image": "Mechanics/CLI/bestiary/elemental/token/pech-lithlord-ccodex.png"
```
^statblock
