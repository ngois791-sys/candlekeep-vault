...
- Pech
---
# [Pech](Mechanics\CLI\bestiary\elemental/pech-ccodex.md)
*Source: Creature Codex p. 294*  
...
"actions":
  - "desc": "The pech makes two attacks. one with its pick and one with its hammer.\
      \ If the pech hits the same target with both attacks, the target must succeed\
      \ on a DC 11 Constitution saving throw or be [incapacitated](Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "CCodex"
"image": "Mechanics/CLI/bestiary/elemental/token/pech-ccodex.png"
```
^statblock
