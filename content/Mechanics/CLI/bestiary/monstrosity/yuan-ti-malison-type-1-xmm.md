...
"actions":
  - "desc": "The yuan-ti makes two attacks, using Bite or Poison Ray in any combination,\
      \ and it can use Spellcasting to cast [Suggestion](Mechanics/CLI/spells/suggestion-xphb.md)\
      \ if available."
    "name": "Multiattack"
...
"source":
  - "XMM"
"image": "Mechanics/CLI/bestiary/monstrosity/token/yuan-ti-malison-type-1-xmm.webp"
```
^statblock
