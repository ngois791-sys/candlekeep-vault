...
- Fungal Acid Ant
---
# [Fungal Acid Ant](Mechanics\CLI\bestiary\monstrosity/fungal-acid-ant-ccodex.md)
...
Acid ants are sometimes found with ordinary giant ants (Tome of Beasts ^[creature/Kobold Press; Tome of Beasts.json]) and giant ant queens. In these cases, the acid ants are a specialized warrior caste within the hive that still answer to the queen.

```statblock
"name": "Fungal Acid Ant (CCodex)"
"size": "Small"
"type": "monstrosity"
"alignment": "Unaligned"
"ac": !!int "13"
...
"cr": "1/4"
"traits":
  - "desc": "A creature that touches the ant or hits it with a melee attack while\
      \ within 5 feet of it must succeed on a DC 11 Constitution saving throw or be\
      \ poisoned until the end of its next turn."
    "name": "Fungi Bloom"
  - "desc": "The ant has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception))\
      \ checks that rely on smell."
    "name": "Keen Smell"
  - "desc": "Perituta fungi spores are attracted to the chitinous shell of acid ants.\
      \ If the green, mossy fungus covers the shell of an ant, it is immune to the\
      \ poisoned condition and replaces the Explosive Death trait with Fungi Bloom"
    "name": "Fungus Covered Shell"
"actions":
