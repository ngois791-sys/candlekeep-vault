...
---
# [Astral Elf Honor Guard](Mechanics\CLI\bestiary\humanoid/astral-elf-honor-guard-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Mechanics/CLI/bestiary/humanoid/token/astral-elf-honor-guard-bam.webp"
```
^statblock