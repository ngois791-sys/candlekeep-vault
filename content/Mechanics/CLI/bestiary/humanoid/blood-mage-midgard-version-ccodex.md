...
---
# [Blood Mage (Midgard Version)](Mechanics\CLI\bestiary\humanoid/blood-mage-midgard-version-ccodex.md)
...
> [!note] Blood Mages in Midgard
> 
> Practiced openly in the Blood Kingdom of Morgau and tolerated in the Mharoti dragon empire, blood magic is a common threat in Midgard's darker lands. Blood mages are often found allied with or creating crimson tusked ogres (see page 279) and [blood zombies](Mechanics/CLI/bestiary/undead/blood-zombie-ccodex.md) (see page 393), and are on good terms with most vampires, liches, and followers of Marena, the Red Goddess. When using the Midgard setting, change the blood mage's spells to the following (see "Fifth Edition Appendix" in the *Midgard World Book* ^[The *Midgard World Handbook* by Kobold Press is currently unconverted for 5eTools.]):
> 
> Cantrips (at will): [acid splash](Mechanics/CLI/spells/acid-splash-xphb.md), blood tide*, [mage hand](Mechanics/CLI/spells/mage-hand-xphb.md), [mending](Mechanics/CLI/spells/mending-xphb.md), [prestidigitation](Mechanics/CLI/spells/prestidigitation-xphb.md)
> 
> 1st level (4 slots): [charm person](Mechanics/CLI/spells/charm-person-xphb.md), [false life](Mechanics/CLI/spells/false-life-xphb.md), stanch*, weapon of blood*
> 
> 2nd level (3 slots): bloodshot*, [hold person](Mechanics/CLI/spells/hold-person-xphb.md)
> 
> 3rd level (3 slots): blood armor*, [dispel magic](Mechanics/CLI/spells/dispel-magic-xphb.md), [fly](Mechanics/CLI/spells/fly-xphb.md), [vampiric touch](Mechanics/CLI/spells/vampiric-touch-xphb.md)
> 
> 4th level (3 slots): [black tentacles](Mechanics/CLI/spells/evards-black-tentacles-xphb.md), [blight](Mechanics/CLI/spells/blight-xphb.md)
> 
> 5th level (2 slots): sanguine horror*, [scrying](Mechanics/CLI/spells/scrying-xphb.md)
^blood-mages-in-midgard

```statblock
"name": "Blood Mage (Midgard Version) (CCodex)"
"size": "Medium"
"type": "humanoid"
"subtype": "any race"
...
"traits":
  - "desc": "The blood mage is a 10th-level spellcaster. Its spellcasting ability\
      ...
      \ *blood tide* ^[The *Midgard World Handbook* by Kobold Press is currently unconverted\
      \ for 5eTools.], [mage hand](Mechanics/CLI/spells/mage-hand-xphb.md), [mending](Mechanics/CLI/spells/mending-xphb.md),\
      ...
      \ [false life](Mechanics/CLI/spells/false-life-xphb.md), *stanch* ^[The *Midgard\
      \ World Handbook* by Kobold Press is currently unconverted for 5eTools.], *weapon\
      \ of blood* ^[The *Midgard World Handbook* by Kobold Press is currently unconverted\
      \ for 5eTools.]\n\n**2nd level (3 slots):** *bloodshot* ^[The *Midgard World\
      \ Handbook* by Kobold Press is currently unconverted for 5eTools.], [hold person](Mechanics/CLI/spells/hold-person-xphb.md)\n\
      \n**3rd level (3 slots):** *blood armor* ^[The *Midgard World Handbook* by Kobold\
      \ Press is currently unconverted for 5eTools.], [dispel magic](Mechanics/CLI/spells/dispel-magic-xphb.md),\
      \ [fly](Mechanics/CLI/spells/fly-xphb.md), [vampiric touch](Mechanics/CLI/spells/vampiric-touch-xphb.md)\n\
      ...
      \ *sanguine horror* ^[The *Midgard World Handbook* by Kobold Press is currently\
      \ unconverted for 5eTools.], [scrying](Mechanics/CLI/spells/scrying-xphb.md)"
    "name": "Spellcasting"
...
"source":
  - "CCodex"
"image": "Mechanics/CLI/bestiary/humanoid/token/blood-mage-midgard-version-ccodex.png"
```
^statblock
