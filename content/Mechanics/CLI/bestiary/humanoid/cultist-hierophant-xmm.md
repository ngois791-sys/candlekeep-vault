...
"actions":
  ...
  - "desc": "The cultist casts one of the following spells, using Charisma as the\
      ...
      \n**1/day each:** [Jallarzi's Storm of Radiance](Mechanics/CLI/spells/jallarzis-storm-of-radiance-xphb.md)\
      \ (level 7 version), [Mass Suggestion](Mechanics/CLI/spells/mass-suggestion-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Mechanics/CLI/bestiary/humanoid/token/cultist-hierophant-xmm.webp"
```
^statblock
