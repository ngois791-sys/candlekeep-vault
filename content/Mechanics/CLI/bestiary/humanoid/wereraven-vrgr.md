...
- Wereraven
---
# [Wereraven](Mechanics\CLI\bestiary\humanoid/wereraven-vrgr.md)
...
"traits":
  ...
  - "desc": "The wereraven can mimic simple sounds it has heard, such as a person\
      ...
      \ the sounds can tell they are imitations with a successful DC 10 Wisdom ([Insight](Mechanics/CLI/rules/skills.md#Insight))\
      \ check."
    "name": "Mimicry"
...
"source":
  - "VRGR"
  - "CM"
"image": "Mechanics/CLI/bestiary/humanoid/token/wereraven-vrgr.webp"
```
^statblock