...
- Red Queen
---
# [Red Queen](Mechanics\CLI\bestiary\beast/red-queen-ccodex.md)
*Source: Creature Codex p. 352*  

The [Queen of Birds](Mechanics/CLI/bestiary/fey/queen-of-birds-ccodex.md) is guarded by a special variety of [terror birds](Mechanics/CLI/bestiary/beast/terror-bird-ccodex.md) with crimson plumage and a golden-green crest rarely seen elsewhere. These terror birds are called red queens, and they are especially savage.
...
"traits":
  ...
  - "desc": "Terror birds who move at least 20 feet straight toward a target have\
    ...
    "name": "Passing Bite"
  - "desc": "Red queens have a limited form of levitation, which allows them to \"\
      run uphill\" on empty air or to cross chasms. This movement must be completed\
      \ between two portions of solid ground within two turns (with [Dash](Mechanics/CLI/rules/actions.md#Dash)\
      \ actions, a red queen bird can move up to 200 feet over empty space)."
    "name": "Levitation"
"actions":
  - "desc": "The red queen makes two serrated beak attacks."
    "name": "Multiattack"
