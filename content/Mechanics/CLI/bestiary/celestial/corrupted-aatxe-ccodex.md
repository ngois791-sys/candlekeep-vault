...
- Corrupted Aatxe
---
# [Corrupted Aatxe](Mechanics\CLI\bestiary\celestial/corrupted-aatxe-ccodex.md)
...
"traits":
  ...
  - "desc": "The aatxe can use its action to polymorph into a Medium male humanoid\
    ...
    "name": "Shapechanger"
  - "desc": "A corrupted aatxe's alignment changes to lawful evil, it has advantage\
      \ on Charisma (Intimidation) checks, and its Bulwark legendary action is replaced\
      \ with Punish."
    "name": "Corruption"
"actions":
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the corrupted aatxe can expend a use to take one of the following actions.\
  \ The corrupted aatxe regains all expended uses at the start of each of its turns."
"legendary_actions":
  ...
  - "desc": "The aatxe flares crimson with celestial power, punishing those daring\
      \ to harm it. The next attack that would hit the aatxe hits the attacker instead."
    "name": "Punish (Costs 3 Actions)"
"source":
  - "CCodex"
