...
- Animal Lord; Forager
---
# [Animal Lord; Forager](Mechanics\CLI\bestiary\celestial/animal-lord-forager-xmm.md)
...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ originating from the animal lord. *Failure:* The target has the [Charmed](Mechanics/CLI/rules/conditions.md#Charmed)\
      \ condition until the end of its next turn. While [Charmed](Mechanics/CLI/rules/conditions.md#Charmed),\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      \ Points](Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md)."
    "name": "Animal Spirit"
