...
- Arrant Quill
---
# [Arrant Quill](Mechanics\CLI\bestiary\npc/arrant-quill-cm.md)
...
"actions":
  ...
  - "desc": "Quill casts one of the following spells using Charisma as the spellcasting\
      \ ability (save DC 17):\n\n**At will:** [light](Mechanics/CLI/spells/light-xphb.md),\
      ...
      \ [mind blank](Mechanics/CLI/spells/mind-blank-xphb.md), [teleport](Mechanics/CLI/spells/teleport-xphb.md)"
    "name": "Spellcasting"
"source":
  - "CM"
"image": "Mechanics/CLI/bestiary/npc/token/arrant-quill-cm.webp"
```
^statblock