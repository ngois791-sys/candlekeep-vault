...
- Mandrake
---
# [Mandrake](Mechanics\CLI\bestiary\plant/mandrake-ccodex.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +2 to hit, reach 5 ft., one target. *Hit:* 5\
      \ (2d4) piercing damage."
    "name": "Bite"
  - "desc": "All creatures within 60 feet of the mandrake that can hear it must succeed\
      \ on a DC 13 Constitution saving throw or take 5 (2d4) thunder damage. If\
...
"source":
  - "CCodex"
"image": "Mechanics/CLI/bestiary/plant/token/mandrake-ccodex.png"
```
^statblock
