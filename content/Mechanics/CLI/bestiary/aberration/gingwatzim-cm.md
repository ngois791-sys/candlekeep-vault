...
- Gingwatzim
---
# [Gingwatzim](Mechanics\CLI\bestiary\aberration/gingwatzim-cm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ saving throw or gain 1 level of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion).\
      \ When the target finishes a short or long rest, the target loses every level\
      \ of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion) gained from\
      \ this attack."
...
"source":
  - "CM"
"image": "Mechanics/CLI/bestiary/aberration/token/gingwatzim-cm.webp"
```
^statblock