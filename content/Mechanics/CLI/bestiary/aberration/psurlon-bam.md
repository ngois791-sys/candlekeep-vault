...
- Psurlon
---
# [Psurlon](Mechanics\CLI\bestiary\aberration/psurlon-bam.md)
...
"actions":
  ...
  - "desc": "The psurlon casts one of the following spells, requiring no spell components\
      ...
      **2/day each:** [disguise self](Mechanics/CLI/spells/disguise-self-xphb.md),\
      \ [mage armor](Mechanics/CLI/spells/mage-armor-xphb.md) (self only)\n\n**1/day:**\
      \ [suggestion](Mechanics/CLI/spells/suggestion-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "BAM"
  - "LoX"
"image": "Mechanics/CLI/bestiary/aberration/token/psurlon-bam.webp"
```
^statblock