...
- Gaj
---
# [Gaj](Mechanics\CLI\bestiary\aberration/gaj-bam.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:*\
      \ 10 (2d6 + 3) slashing damage, and the target is [grappled](Mechanics/CLI/rules/conditions.md#Grappled)\
    ...
    "name": "Mandibles"
  - "desc": "The gaj targets one creature [grappled](Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "The gaj magically targets one creature it can see within 60 feet of itself.\
      \ The target must succeed on a DC 12 Wisdom saving throw or be [paralyzed](Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"source":
  - "BAM"
  - "LoX"
"image": "Mechanics/CLI/bestiary/aberration/token/gaj-bam.webp"
```
^statblock