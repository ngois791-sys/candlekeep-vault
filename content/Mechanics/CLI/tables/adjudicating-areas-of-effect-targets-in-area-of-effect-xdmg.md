...
*Use this column for [Cylinders](Mechanics/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).