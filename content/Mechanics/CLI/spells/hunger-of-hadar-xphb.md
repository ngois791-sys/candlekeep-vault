...
You open a gateway to the Far Realm, a region infested with unspeakable horrors. A 20-foot-radius [Sphere](Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) of [Darkness](Mechanics/CLI/rules/variant-rules/darkness-xphb.md) appears, centered on a point with range and lasting for the duration. The [Sphere](Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) is [Difficult Terrain](Mechanics/CLI/rules/variant-rules/difficult-terrain-xphb.md), and it is filled with strange whispers and slurping noises, which can be heard up to 30 feet away. No light, magical or otherwise, can illuminate the area, and creatures fully within it have the [Blinded](Mechanics/CLI/rules/conditions.md#Blinded) condition.
