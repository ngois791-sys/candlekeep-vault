...
A Cannon uses gunpowder or arcane power to propel heavy iron balls at destructive speeds. A Cannon is usually attached to a wooden frame with wheels. Loading a Cannon requires the [Utilize](Mechanics/CLI/rules/actions.md#Utilize) action, and aiming it requires another [Utilize](Mechanics/CLI/rules/actions.md#Utilize) action. Then a crew member can take the Cannonball action.

```ad-statblock
title: Cannon
![](Mechanics/CLI/objects/token/cannon-xdmg.webp#token)
*Large Siege weapon*
