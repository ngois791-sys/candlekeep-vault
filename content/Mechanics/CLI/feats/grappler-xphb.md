...
**Punch and Grab.** When you hit a creature with an Unarmed Strike as part of the [Attack](Mechanics/CLI/rules/actions.md#Attack) action on your turn, you can use both the Damage and the Grapple option. You can use this benefit only once per turn.

**Attack Advantage.** You have Advantage on attack rolls against a creature [Grappled](Mechanics/CLI/rules/conditions.md#Grappled) by you.
