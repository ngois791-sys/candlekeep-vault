...
At the start of your first turn of each combat, your [Speed](Mechanics/CLI/rules/variant-rules/speed-xphb.md) increases by 10 feet until the end of that turn.
...
When you roll [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](Mechanics/CLI/rules/conditions.md#Frightened) condition until the start of your next turn.
