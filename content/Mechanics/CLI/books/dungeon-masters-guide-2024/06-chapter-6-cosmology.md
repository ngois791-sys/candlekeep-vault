...
![The Lady of Pain appears w...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/084-06-001-the-lady-of-pain.webp#center "The Lady of Pain appears without warning in the bustling streets of Sigil, and the city's residents get out of her way")
...
![Outer Planes](Mechanics/CLI/tables/outer-planes-xdmg.md)
...
![](Mechanics/CLI/books/dungeon-masters-guide-2024/img/085-06-002-the-multiverse.webp#center)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](Mechanics/CLI/spells/gate-xphb.md) and [Plane Shift](Mechanics/CLI/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](Mechanics/CLI/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](Mechanics/CLI/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![A portal to the Beastlands...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/086-06-003-portal-to-the-beastlands.webp#center "A portal to the Beastlands opens amid the branches of the World Tree")
...
![Planar Adventure Situations](Mechanics/CLI/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](Mechanics/CLI/tables/layers-of-the-abyss-xdmg.md)
...
![The detritus of the Planes...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/087-06-004-demonweb-pits.webp#center "The detritus of the Planes is tangled in the Demonweb Pits")
...
![Layers of Acheron](Mechanics/CLI/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](Mechanics/CLI/tables/layers-of-arborea-xdmg.md)
...
![](Mechanics/CLI/books/dungeon-masters-guide-2024/img/088-06-005-arcadia.webp#center)
...
![Layers of Arcadia](Mechanics/CLI/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](Mechanics/CLI/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](Mechanics/CLI/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](Mechanics/CLI/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](Mechanics/CLI/tables/layers-of-bytopia-xdmg.md)
...
![Aarakocra scouts return ho...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/091-06-008-plane-of-air.webp#center "Aarakocra scouts return home to a city on the Plane of Air")
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](Mechanics/CLI/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![The City of Brass is a hub...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/092-06-009-city-of-brass.webp#center "The City of Brass is a hub for trade from across the multiverse")
...
![Layers of Elysium](Mechanics/CLI/tables/layers-of-elysium-xdmg.md)
...
Belierin is said to be the prison of some deadly creature. Some tales say it's a powerful titan, perhaps the [tarrasque](Mechanics/CLI/bestiary/monstrosity/tarrasque-xmm.md), while others claim it's a deposed duke of the Nine Hells, a banished elemental prince, or even a near-dead deity. Evil creatures sometimes lurk in the marshes, seeking to free the prisoner or claim some power from it.
...
Characters can use the [Etherealness](Mechanics/CLI/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](Mechanics/CLI/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
To reach the Deep Ethereal, one typically needs a [Plane Shift](Mechanics/CLI/spells/plane-shift-xphb.md) spell, a [Gate](Mechanics/CLI/spells/gate-xphb.md) spell, or a magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table. The curtains are also distinguishable by texture and temperature, each one reflecting something of the nature of the plane beyond.

![The Radiant Citadel is a r...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/093-06-010-the-radiant-citadel.webp#center "The Radiant Citadel is a refuge in the Ethereal Plane, despite its proximity to a raging ether cyclone")

![Deep Ethereal; Ethereal Curtains](Mechanics/CLI/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting everything in its path and carrying the debris for miles. Travelers with a [Passive Perception](Mechanics/CLI/rules/variant-rules/passive-perception-xphb.md) score of 15 or higher receive 1 minute of warning: a deep thrum in the ethereal matter. Travelers who can't reach a curtain or portal leading elsewhere suffer the cyclone's effect. Roll `1d20` and consult the Ether Cyclone table to determine the effect on all creatures in the vicinity.

![Ether Cyclones; Ether Cyclone](Mechanics/CLI/tables/ether-cyclones-ether-cyclone-xdmg.md)

#### Radiant Citadel

![](Mechanics/CLI/books/dungeon-masters-guide-2024/img/094-06-011-lotus.webp#center)
...
![When the Dragon's Tear com...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/095-06-012-the-vast-gate.webp#center "When the Dragon's Tear comet appears above Firestorm Peak, the Vast Gate forms a bridge to the Far Realm")
...
![Feywild Time Warp](Mechanics/CLI/tables/feywild-time-warp-xdmg.md)
...
![Fey revel in the Gloaming ...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/096-06-013-the-gloaming-court.webp#center "Fey revel in the Gloaming Court under the watchful eye of the Queen of Air and Darkness")
...
![Layers of Gehenna](Mechanics/CLI/tables/layers-of-gehenna-xdmg.md)
...
![Layers of Hades](Mechanics/CLI/tables/layers-of-hades-xdmg.md)

#### Plane of Gloom

At the end of each Long Rest taken on the plane, a visitor makes a DC 10 Wisdom saving throw. On a failed save, the creature gains 1 [Exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion) level that can't be removed while the creature is in Hades. If the creature reaches 6 Exhaustion levels, it doesn't die. Instead, it permanently transforms into a [Larva](Mechanics/CLI/bestiary/fiend/larva-xmm.md), whereupon all Exhaustion levels afflicting the creature are removed.
...
![With its magical marvels o...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/097-06-014-eberron-technology.webp#center "With its magical marvels of technology, Eberron is one of countless worlds on the Material Plane")
...
![The Seven Heavens of Mount...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/098-06-015-mount-celestia.webp#center "The Seven Heavens of Mount Celestia beckon virtuous souls toward ever-greater heights")

![Layers of Mount Celestia](Mechanics/CLI/tables/layers-of-mount-celestia-xdmg.md)
...
![Layers of the Nine Hells](Mechanics/CLI/tables/layers-of-the-nine-hells-xdmg.md)

#### Avernus

![The first of Nine Hells, A...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/099-06-016-avernus.webp#center "The first of Nine Hells, Avernus, is an eternal battlefield in the Blood War")
...
![Asmodeus, the Lord of the ...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/100-06-017-asmodeus.webp#center "Asmodeus, the Lord of the Nine, maintains a veneer of pleasantry while inflicting agony on imprisoned souls")
...
![Gate-Towns of the Outlands](Mechanics/CLI/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](Mechanics/CLI/tables/layers-of-pandemonium-xdmg.md)
...
![Three adventurers brave th...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/101-06-018-winds-of-pandemonium.webp#center "Three adventurers brave the howling winds of Pandemonium in search of Howler's Crag")
...
![The Shadowfell is a realm ...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/102-06-019-the-shadowfell.webp#center "The Shadowfell is a realm of death, despair, and dread")
...
![In the cosmopolitan street...](Mechanics/CLI/books/dungeon-masters-guide-2024/img/103-06-020-citizens-of-sigil.webp#center "In the cosmopolitan streets of Sigil, creatures from across the multiverse coexist in uneasy peace")
...
![Layers of Ysgard](Mechanics/CLI/tables/layers-of-ysgard-xdmg.md)
