...
![](Mechanics/CLI/books/monster-manual-2025/img/stat-block-overview.webp#center)
...
- **Combat Highlights.** [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md), [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), [Speed](Mechanics/CLI/rules/variant-rules/speed-xphb.md), and [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) are provided here.  
...
- **Treasure Theme ([Arcana](Mechanics/CLI/tables/random-magic-items-arcana.md), [Armaments](Mechanics/CLI/tables/random-magic-items-armaments.md), [Implements](Mechanics/CLI/tables/random-magic-items-implements.md), or [Relics](Mechanics/CLI/tables/random-magic-items-relics.md)).** The monster's treasure hoard features magic items with the noted theme. The "Dungeon Master's Guide" details treasure hoards appropriate for each theme.  
...
The rules for a [stat block](Mechanics/CLI/rules/variant-rules/stat-block-xphb.md) are detailed in the rules glossary of the "Player's Handbook" and in this section.
...
A monster's [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md) (AC) includes its natural armor, Dexterity, gear, and other defenses. See the "Player's Handbook" for information on [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md).

### Initiative

The [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) entry specifies the monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) modifier followed by the monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) score in parentheses. Use the modifier when you roll to determine a monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md). A monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) modifier is typically equal to its Dexterity modifier, but some monsters have additional modifiers, such as [Proficiency Bonus](Mechanics/CLI/rules/variant-rules/proficiency-xphb.md), applied to that number.

If you don't want to roll a monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md), use the [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) score as the monster's [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) in combat. [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) is further detailed in the "Player's Handbook".

### Hit Points

A monster's [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) are presented as a number followed by parentheses, where the monster's [Hit Point Dice](Mechanics/CLI/rules/variant-rules/hit-point-dice-xphb.md) are provided, along with any contribution from its Constitution. Either use the number for the monster's [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) or roll the die expression in parentheses to determine the monster's [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) randomly; don't use both.

A monster's size typically determines the die used to calculate its [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), as shown in the Hit Dice by [Size](Mechanics/CLI/rules/variant-rules/size-xphb.md) table.

![Parts of a Stat Block; Hit Dice by Size](Mechanics/CLI/tables/parts-of-a-stat-block-hit-dice-by-size-xmm.md)

A monster's Constitution modifier is multiplied by the number of Hit Dice it possesses, and the result is added to its [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md). For example, if a monster has a Constitution of 12 (+1 modifier) and `2d8` Hit Dice, it has `2d8 + 2` [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) (average 11).

For more on [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), see the "Player's Handbook".

### Speed

The Speed entry specifies a monster's Speed. Some monsters have one or more of the following speeds: [Burrow](Mechanics/CLI/rules/variant-rules/burrow-speed-xphb.md), [Climb](Mechanics/CLI/rules/variant-rules/climb-speed-xphb.md), [Fly](Mechanics/CLI/rules/variant-rules/fly-speed-xphb.md), [Swim](Mechanics/CLI/rules/variant-rules/swim-speed-xphb.md). Rules for [Speed](Mechanics/CLI/rules/variant-rules/speed-xphb.md) and these specials speeds appear in the "Player's Handbook".
...
The Skills entry specifies a monster's skill proficiencies, if any. For example, a monster that is very perceptive and stealthy might have bonuses to Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) and Dexterity ([Stealth](Mechanics/CLI/rules/skills.md#Stealth)) checks. A skill bonus is the sum of a monster's relevant ability modifier and its [Proficiency Bonus](Mechanics/CLI/rules/variant-rules/proficiency-xphb.md). Other modifiers might apply.

### Resistances and Vulnerabilities

These entries list a monster's [Resistances](Mechanics/CLI/rules/variant-rules/resistance-xphb.md) and [Vulnerabilities](Mechanics/CLI/rules/variant-rules/vulnerability-xphb.md), if any. See the "Player's Handbook" for more information.

### Immunities

This entry lists the monster's [Immunities](Mechanics/CLI/rules/variant-rules/immunity-xphb.md), if any. If the monster has damage and condition Immunities, the damage types are listed before the conditions. See the "Player's Handbook" for details.
...
Beware of giving a monster combat-oriented magic items, since those might alter the monster's [Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md). If you do give a monster a magic item, the monster can have [Attunement](Mechanics/CLI/rules/variant-rules/attunement-xphb.md) with magic items as noted in the "Player's Handbook". A monster with a class tag after its creature type is considered a member of that class for [Attunement](Mechanics/CLI/rules/variant-rules/attunement-xphb.md) purposes.

> [!note] Running a Monster
> 
> To ensure a monster acts in accordance with its [Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md), follow these rules during combat:
> 
...
The Senses entry specifies a monster's [Passive Perception](Mechanics/CLI/rules/variant-rules/passive-perception-xphb.md) score, as well as any special senses the monster possesses. [Passive Perception](Mechanics/CLI/rules/variant-rules/passive-perception-xphb.md) and "special senses" are described in the "Player's Handbook".
...
[Telepathy](Mechanics/CLI/rules/variant-rules/telepathy-xphb.md) is a magical ability that allows a creature to communicate mentally with another creature within a specified range. See the "Player's Handbook" for more information.

### Challenge Rating

[Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md) is defined in the "Player's Handbook", while guidance on using CR to plan potential combat encounters is in the "Dungeon Master's Guide". Lists of monsters organized by [Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md) appear in "appendix B".

#### Experience Points

The number of [Experience Points](Mechanics/CLI/rules/variant-rules/experience-points-xphb.md) (XP) a monster is worth is based on its CR, as detailed in the [Experience Points](Mechanics/CLI/rules/variant-rules/experience-points-xphb.md) by [Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md) table. XP is awarded for defeating the monster in combat or otherwise neutralizing it.
...
![Experience Points by Challenge Rating](Mechanics/CLI/tables/experience-points-by-challenge-rating-xmm.md)

#### Proficiency Bonus

A monster's [Proficiency Bonus](Mechanics/CLI/rules/variant-rules/proficiency-xphb.md) (PB) is determined by its CR, as shown in the [Proficiency Bonus](Mechanics/CLI/rules/variant-rules/proficiency-xphb.md) by [Challenge Rating](Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md) table, and is reflected in saving throws, skills, and other statistics where the monster's exceptional aptitude is a factor.

![Proficiency Bonus by Challenge Rating](Mechanics/CLI/tables/proficiency-bonus-by-challenge-rating-xmm.md)
...
Some creatures can make more than one attack when they take the [Attack](Mechanics/CLI/rules/actions.md#Attack) action. Such creatures have the Multiattack entry in the "Actions" section of their stat block. This entry details the attacks a creature can make, as well as any additional abilities it can use, as part of the [Attack](Mechanics/CLI/rules/actions.md#Attack) action.
...
A monster's spell can have special rules or restrictions. For example, a [green slaad](Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) can cast the [Invisibility](Mechanics/CLI/spells/invisibility-xphb.md) spell, but the spell has a "self only" restriction, which means the spell affects only the slaad.
...
If a spell has a casting time of 1 minute or more yet is listed in a spellcasting action, the monster doesn't cast the spell in just one action unless the action's description states otherwise; the monster must take the [Magic](Mechanics/CLI/rules/actions.md#Magic) action on each of its turns and maintain [Concentration](Mechanics/CLI/rules/conditions.md#Concentration) to cast the spell, as described in the "Player's Handbook".

### Bonus Action

If a monster has Bonus Action options, they are listed in this section. See the "Player's Handbook" for details on [Bonus Actions](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md).

### Reactions

If the monster has Reaction options, those are listed in this section along with their triggers. See the "Player's Handbook" for details on [Reactions](Mechanics/CLI/rules/variant-rules/reaction-xphb.md).

### Legendary Actions

If the monster has Legendary Action options, those are listed in this section. A Legendary Action is an action that a monster can take immediately after another creature's turn. Only one of these actions can be taken at a time and only after another creature's turn ends. The monster can't take a Legendary Action if it has the [Incapacitated](Mechanics/CLI/rules/conditions.md#Incapacitated) condition or is otherwise unable to take actions.
...
- **X/Day.** This notation means the stat block part can be used a certain number of times (represented by X) and that a monster must finish a [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md) to regain expended uses. For example, a [Reaction](Mechanics/CLI/rules/variant-rules/reaction-xphb.md) that includes "1/Day" means the [Reaction](Mechanics/CLI/rules/variant-rules/reaction-xphb.md) can be taken once and that the monster must finish a [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md) to take it again.  
- **Recharge X–Y.** This notation means a monster can use the stat block part once. At the start of each of the monster's turns, roll `1d6`. If the roll is within the number range given in the notation (represented by X–Y), the monster regains the use of that part, which also recharges when the monster finishes a [Short](Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md). For example, "Recharge 5–6" in an action means a monster can take the action once. Then, at the start of each of the monster's turns, it regains the use of that action if it rolls a 5 or 6 on `1d6`.  
- **Recharge after a Short or Long Rest.** This notation means the monster can use the stat block part once and must then finish a [Short](Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md) to use it again.