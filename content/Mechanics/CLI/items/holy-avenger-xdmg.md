...
![](Mechanics/CLI/items/img/holy-avenger.webp#right)
...
While you hold the drawn weapon, it creates a 10-foot [Emanation](Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from you. You and all creatures [Friendly](Mechanics/CLI/rules/variant-rules/friendly-attitude-xphb.md) to you in the [Emanation](Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) have [Advantage](Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects. If you have 17 or more levels in the Paladin class, the size of the [Emanation](Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) increases to 30 feet.
