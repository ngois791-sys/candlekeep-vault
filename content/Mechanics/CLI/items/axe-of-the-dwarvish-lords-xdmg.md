...
---
# Axe of the Dwarvish Lords
*Weapon ([battleaxe](Mechanics/CLI/items/battleaxe-xphb.md)), artifact (requires attunement)*  
...
The axe has [Thrown](Mechanics/CLI/rules/item-properties.md#Thrown) with a normal range of 20 feet and a long range of 60 feet. When you hit with a ranged attack using this weapon, it deals an extra `1d8` Force damage, or an extra `2d8` Force damage if the target is a creature of the Giant type. Immediately after hitting or missing, the weapon flies back to your hand.

## Blessings of Moradin

While attuned to the axe, you gain the following benefits:

- **Darkvision.** You gain [Darkvision](Mechanics/CLI/rules/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](Mechanics/CLI/rules/senses.md#Darkvision), its range increases by 60 feet.  
- **Fortitude of Stone.** Your Constitution increases by 2, to a maximum of 20.  
- **Gifts of the Creator.** You have proficiency with [Brewer's Supplies](Mechanics/CLI/items/brewers-supplies-xphb.md), [Mason's Tools](Mechanics/CLI/items/masons-tools-xphb.md), and [Smith's Tools](Mechanics/CLI/items/smiths-tools-xphb.md).  
- **One with the Forge.** You have [Immunity](Mechanics/CLI/rules/variant-rules/immunity-xphb.md) to Poison damage and [Resistance](Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Fire damage.  
- **Sunder.** When you hit an object with the axe, the object takes the maximum amount of damage possible.  

## Conjure Earth Elemental

While holding the axe, you can take a [Magic](Mechanics/CLI/rules/actions.md#Magic) action to summon an [Earth Elemental](Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md). It appears in an unoccupied space you choose within 30 feet of yourself, understands your languages, obeys your commands, and takes its turn immediately after you on your [Initiative](Mechanics/CLI/rules/variant-rules/initiative-xphb.md) count. The elemental disappears after 24 hours, when it dies, or when you dismiss it as a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md). You can't use this property again until the next dawn.
