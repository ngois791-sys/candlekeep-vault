...
The staff has 10 charges, which are used to fuel the spells within it. With the staff in hand, you can use your action to cast one of the following spells from the staff if the spell is on your class's spell list: [spider climb](Mechanics/CLI/spells/spider-climb-xphb.md) (1 charge) or [web](Mechanics/CLI/spells/web-xphb.md) (2 charges, spell save DC 15). No components are required.
