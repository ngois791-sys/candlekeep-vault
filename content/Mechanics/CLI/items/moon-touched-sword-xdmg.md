...
# Moon-Touched Sword
*Common*  
![](Mechanics/CLI/items/img/moon-touched-sword.webp#right)


In [Darkness](Mechanics/CLI/rules/variant-rules/darkness-xphb.md), the unsheathed blade of this weapon sheds moonlight, creating [Bright Light](Mechanics/CLI/rules/variant-rules/bright-light-xphb.md) in a 15-foot radius and [Dim Light](Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 15 feet.
