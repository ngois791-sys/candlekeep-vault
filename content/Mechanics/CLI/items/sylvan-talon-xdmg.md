...
![](Mechanics/CLI/items/img/sylvan-talon.webp#right)
...
As a [Magic](Mechanics/CLI/rules/actions.md#Magic) action, you can use the weapon to cast [Message](Mechanics/CLI/spells/message-xphb.md). Once this property is used, it can't be used again until the next dawn.
