...
A creature subjected to Torpor poison must succeed on a DC 15 Constitution saving throw or have the [Poisoned](Mechanics/CLI/rules/conditions.md#Poisoned) condition for `4d6` hours. The creature's [Speed](Mechanics/CLI/rules/variant-rules/speed-xphb.md) is halved while the creature is [Poisoned](Mechanics/CLI/rules/conditions.md#Poisoned) in this way.
