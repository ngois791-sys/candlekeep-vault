...
While attuned to the book, you have [Immunity](Mechanics/CLI/rules/variant-rules/immunity-xphb.md) to the [Charmed](Mechanics/CLI/rules/conditions.md#Charmed) and [Frightened](Mechanics/CLI/rules/conditions.md#Frightened) conditions and [Resistance](Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Psychic damage. These benefits become permanent after you spend the requisite amount of time reading and studying the book.
...
After you spend the requisite amount of time reading and studying the book, you gain a protective halo. This halo sheds [Bright Light](Mechanics/CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet. You can dismiss or manifest the halo as a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md). While present, the halo gives you [Advantage](Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on Charisma ([Persuasion](Mechanics/CLI/rules/skills.md#Persuasion)) checks. In addition, Fiends and Undead within the halo's [Bright Light](Mechanics/CLI/rules/variant-rules/bright-light-xphb.md) make attack rolls against you with [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md).
...
- 2 [major beneficial](Mechanics/CLI/tables/artifact-properties-major-beneficial-properties-xdmg.md) properties  
