...
Any creature besides Orcus that tries to attune to the wand makes a DC 17 Constitution saving throw. On a successful save, the creature takes `10d6` Necrotic damage. On a failed save, the creature dies and, if it is a Humanoid, turns into a [Zombie](Mechanics/CLI/bestiary/undead/zombie-xmm.md).

## Magic Weapon

You can wield the wand as a magic [Mace](Mechanics/CLI/items/mace-xphb.md) that grants a +3 bonus to attack rolls and damage rolls made with it. The wand deals an extra `2d12` Necrotic damage on a hit.
...
- 2 [minor detrimental](Mechanics/CLI/tables/artifact-properties-minor-detrimental-properties-xdmg.md) properties  
...
You gain a +3 bonus to [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md) while holding the wand.
...
| Spell | Charge Cost |
|-------|-------------|
| [Animate Dead](Mechanics/CLI/spells/animate-dead-xphb.md) | 1 |
| [Blight](Mechanics/CLI/spells/blight-xphb.md) | 2 |
| [Circle of Death](Mechanics/CLI/spells/circle-of-death-xphb.md) | 3 |
| [Finger of Death](Mechanics/CLI/spells/finger-of-death-xphb.md) | 3 |
| [Power Word Kill](Mechanics/CLI/spells/power-word-kill-xphb.md) | 4 |
| [Speak with Dead](Mechanics/CLI/spells/speak-with-dead-xphb.md) | 1 |
^spell-charge-cost
...
While holding the wand, you can take a [Magic](Mechanics/CLI/rules/actions.md#Magic) action to conjure 15 [Skeletons](Mechanics/CLI/bestiary/undead/skeleton-xmm.md) and 15 [Zombies](Mechanics/CLI/bestiary/undead/zombie-xmm.md). These Undead magically rise up from the ground or otherwise form in unoccupied spaces within 300 feet of you and obey your commands until they are destroyed or until the next dawn, when they collapse into inanimate piles of bones and rotting corpses. Once you use this property, you can't use it again until the next dawn.
...
The Wand of Orcus is a sentient Chaotic Evil item with an Intelligence of 16, a Wisdom of 12, and a Charisma of 16. It has hearing and [Darkvision](Mechanics/CLI/rules/senses.md#Darkvision) out to 120 feet.
