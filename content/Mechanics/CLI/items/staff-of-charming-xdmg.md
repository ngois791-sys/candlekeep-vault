...
- **Cast Spell.** You can expend 1 of the staff's charges to cast [Charm Person](Mechanics/CLI/spells/charm-person-xphb.md), [Command](Mechanics/CLI/spells/command-xphb.md), or [Comprehend Languages](Mechanics/CLI/spells/comprehend-languages-xphb.md) from it using your spell save DC.  
- **Reflect Enchantment.** If you succeed on a saving throw against an Enchantment spell that targets only you, you can take a [Reaction](Mechanics/CLI/rules/variant-rules/reaction-xphb.md) to expend 1 charge from the staff and turn the spell back on its caster as if you had cast the spell.  
