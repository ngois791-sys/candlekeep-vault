...
If the armor normally imposes disadvantage on Dexterity ([Stealth](Mechanics/CLI/rules/skills.md#Stealth)) checks or has a Strength requirement, the mithral version of the armor doesn't.
