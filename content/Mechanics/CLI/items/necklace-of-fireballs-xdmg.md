...
This necklace has `1d6 + 3` beads hanging from it. You can take a [Magic](Mechanics/CLI/rules/actions.md#Magic) action to detach a bead and throw it up to 60 feet away. When it reaches the end of its trajectory, the bead detonates as a level 3 [Fireball](Mechanics/CLI/spells/fireball-xphb.md) (save DC 15).
