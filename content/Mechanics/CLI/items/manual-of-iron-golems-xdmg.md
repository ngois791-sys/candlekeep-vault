...
This tome contains information and incantations necessary to make a [iron golem](Mechanics/CLI/bestiary/construct/iron-golem-xmm.md). To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a *manual of golems* and attempts to read it takes `6d6` psychic damage.
