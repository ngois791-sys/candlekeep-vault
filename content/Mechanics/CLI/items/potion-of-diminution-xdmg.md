...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](Mechanics/CLI/spells/enlarge-reduce-xphb.md) spell for `1d4` hours (no [Concentration](Mechanics/CLI/rules/conditions.md#Concentration) required).
