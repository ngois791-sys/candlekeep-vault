...
While wearing this circlet, you can cast [Scorching Ray](Mechanics/CLI/spells/scorching-ray-xphb.md) with it (`+5` to hit). The circlet can't cast this spell again until the next dawn.
