...
![](Mechanics/CLI/items/img/luck-blade.webp#right)
...
If the weapon is on your person, you can call on its luck (no action required) to reroll one failed [D20 Test](Mechanics/CLI/rules/variant-rules/d20-test-xphb.md) if you don't have the [Incapacitated](Mechanics/CLI/rules/conditions.md#Incapacitated) condition. You must use the second roll. Once used, this property can't be used again until the next dawn.

## Wish

The weapon has `1d3` charges. While holding it, you can expend 1 charge and cast [Wish](Mechanics/CLI/spells/wish-xphb.md) from it. Once used, this property can't be used again until the next dawn. The weapon loses this property if it has no charges.
